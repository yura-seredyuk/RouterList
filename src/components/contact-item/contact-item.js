...
export default class ContactItem extends React.Component {
    render() {
        const { name, address, phone, email, gender, favourite, avatar, isFavourite, onDelete, editContact } = this.props
            ...
            <li className="list-group-item">
                <div className="row w-100">
                    ...
                    <div className="col-12 col-sm-6 col-md-9 text-center text-sm-left">
                        ...
                        <Link
                            to="/edit"
                            className="float-right pulse edit"
                            onClick={editContact}
                        >
                            <i className={`far fa-edit fa-2x`} title="edit" ></i>
                        </Link>
